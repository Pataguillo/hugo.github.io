          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <img src="/frontend/img/Ciber.jpeg" class="img-fluid" style="width: 185px;" height="50px">
                  <h4 class="mt-1 mb-5 pb-1">Tu jornada comienza aquí. Inicia sesión para disfrutar.</h4>
                </div>
                            ...
                            <div class="form-outline mb-4">
                              ...
                              <div class="text-center pt-1 mb-5 pb-1">
                                <div class="form-group login-btn">
                                        ...
                                        <a href="{{route('register.form')}}" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3">Registrate</a>
                                </div>
                                </div>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                ...
                <p class="small mb-0">CSI Surge ante las  necesidades mostradas por el mercado de consumidores de 
                  equipos de cómputo y consumibles,manejamos una gran gama de productos en la industria informática.</p>
              </div>
            </div>
          </div>
        </div>
