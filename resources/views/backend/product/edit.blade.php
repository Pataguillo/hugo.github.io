...
<div class="container-fluid px-4">
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="../../product">Inicio</a></li>
    ...
    <div class="card text-bg-light">
      <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
        ...
        <div class="col-12">
          ...
          <input class="form-control" id="summary" name="summary" value="{{$product->summary}}"></input>
          @error('summary')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="col-12">
          <label for="is_featured">Featura</label><br>
        ...
        <div class="col-12">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)              
                ...
                // dd($data);
                @endphp
              <option value="S"  @if( in_array( "S",$data ) ) selected @endif>Chico</option>
