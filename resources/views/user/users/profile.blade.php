...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('admin')}}" style="color:#999">Centro de Control</a></li>
         <li><a href="" class="active text-primary">Prefil</a></li>
     </ul>
   </div>
   <div class="card-body">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        <img class="card-img-top img-fluid roundend-circle mt-4" src="{{ asset($profile->photo) }}" 
                        alt="{{$profile->photo}}">
                    ...
                    <div class="form-group">
                      ...
                      <label for="inputPhoto" class="col-form-label">Foto</label>
                            <div class="input-group"> 
                                <input id="thumbnail" type="file" name="photo" class="form-control" alue="{{$profile->photo}}" accept="image/*">
                            </div>
